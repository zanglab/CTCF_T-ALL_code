...
#def reads_count_on_mapfile(infile,readsfile,species,format,fragmentsize=147,mid=False,expand=0):
def reads_positions(readsfile,species,format,fragmentsize=147):
    '''
    return the position of reads in bed/bam file
    positions[chr] = [shifted position (plus+shift, minus-shift) of all reads]
    '''
    #specify the species
