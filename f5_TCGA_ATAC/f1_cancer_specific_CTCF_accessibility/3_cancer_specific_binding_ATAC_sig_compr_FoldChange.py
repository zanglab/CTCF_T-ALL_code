...
cancertype_match_names_title ={'BRCA':'BRCA','CRC':'CRC','LUAD':'LUAD','PRAD':'PRAD','PRAD_TissueAdded':'PRAD'}
...
def compr_plot_box(gained_df,lost_df,const_df,cancer_columns,ctrl_columns,outdir,cancertype,flag):
    ...
    plt.title('{}'.format(cancertype_match_names_title[cancertype]),fontsize=20,va='baseline')
...
def compr_binding_signal(indir,flag,outdir):
    ...
    for cancertype in cancertypes:
        if 1:         
            ...
            const_file = '{}/{}_constitutive_ATAC_sig.bed'.format(indir,cancertype)
