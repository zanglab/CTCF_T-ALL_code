...
def mark_pvalue(compr_pos,positions,box_vals):
    ...
    y, h, col = np.percentile(np.append(box_vals[compr_pos[0]],box_vals[compr_pos[1]]),99.5)*1.3 ,1.1, 'k'
...
def main():
    ...
    signal_df = pd.read_csv('f2_combined_RPKM_csv/Jurkat_CD4_ATAC_combined_RPKM_log2_QN.csv',index_col=0)
    ...
    figname = 'Jurkat_vs_CD4_ATAC_signal_on_TALL_CTCF.png'
...
#         patch.set_alpha(0.9)
    ...
    plt.ylabel('ATAC-seq \ndifferential score',fontsize=20)
