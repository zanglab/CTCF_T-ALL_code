...
def main_sep_data(clinical_data):
    ...
    outdir = 'f3_combined_ATAC_sig_diff_score_and_clinical_info_{}'.format(clinical_data)
...
#         clinical_file = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/15_TCGA_patient_data/clinical_survival/data_TCGA_clinical/clinical.cases_{}.2019-07-23/clinical.tsv'.format(name_types_cancer_match[name_type])
#         clinical_file = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/15_TCGA_patient_data/clinical_survival/data_TCGA_clinical/clinical.cases_{}.2019-04-08/clinical.tsv'.format(name_types_cancer_match[name_type])
        clinical_file = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/15_TCGA_patient_data/clinical_survival/data_TCGA_clinical/clinical.cases_{}.{}/clinical.tsv'.format(name_types_cancer_match[name_type],clinical_data)
...
def main(infile):
    ...
    for clinical_data in ['2019-07-23','2019-04-08']:
