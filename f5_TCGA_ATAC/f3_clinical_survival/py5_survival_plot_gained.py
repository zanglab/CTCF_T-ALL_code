...
def main_sep_data(clinical_data):
    ...
    outdir = 'f5_survival_figs_gained_{}'.format(clinical_data)
    os.makedirs(outdir,exist_ok=True)
    
#     combined_file_dir='../f2_clinical_survival_panCancer_saved/f3_combined_ATAC_sig_diff_score_and_clinical_info'
    combined_file_dir='f3_combined_ATAC_sig_diff_score_and_clinical_info_{}'.format(clinical_data)
...
def main():
    ...
    for clinical_data in ['2019-04-08','2019-07-23',]:
