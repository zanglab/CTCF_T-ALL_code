...
python find_overlap_keep_info_NOT_sep_strand.py -a union_CTCF_No_Jurkat_DNAmethylation_with_motif.bed -b Jurkat_ATAC_peaks.narrowPeak -p union_CTCF_No_Jurkat_DNAmethylation_with_motif_ATAC_peak_overlapped.bed -s hg38
