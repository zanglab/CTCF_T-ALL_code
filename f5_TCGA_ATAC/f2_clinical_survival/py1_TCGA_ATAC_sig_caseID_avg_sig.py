...
def main(infile):
    ...
    atac_sig_file_dir = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/updated_201906/f5_TCGA_ATAC/f1_cancer_specific_CTCF_accessibility/f1_ATAC_sig_abstract/log2norm'
