...
def main():
    ...
    outdir = 'f2_scatter_plot_figs_QN'
    ...
    indir='/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/updated_201906/f11_GSI_shCTCF/f5_GSI_ATAC_chip_20191029/f1_results_from_bam/f1_binding_signal_csv/binding_changes_QN'
