...
cancer_type_matched = {'T-ALL':['CD4','JURKAT','CUTLL1','PD9','PD31'],'BRCA':['Breast_normal','BRCA'],'LUAD':['Lung_normal','LUAD',],'CRC':['Colon_normal','CRC'],'PRAD':['CRC'],'AML':['AML','Erythroid']}
...
def return_hm_bam_file(prename):
    ...
    file4 = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/updated_201906/f9_histone_modification/download/data_process/process_qc_out/{}/{}_{}.bam'.format(prename,prename,prename)
    for isfile in [file1,file2,file3,file4]:
