...
cancer_type_matched = {'T-ALL':['CD4','JURKAT','CUTLL1','PD9','PD31']}

ctcf_cancer_type_matched = {'T-ALL':['T-ALL_normal','T-ALL_cancer_JURKAT','T-ALL_cancer_CUTLL1','PD9','PD31']}
    
cancer_type_matched_title = {'T-ALL':['T cell','Jurkat','CUTLL1','T-ALL \npatient1','T-ALL \npatient2']}
...
#         ax.set_axis_off()
    ...
    if hm == 'H3K27me3' and loc==total-1:
...
def main():
    ...
    outdir = 'f4_HM_heatmap_combined_patients'
