...
#     union_df = CTCF_TALL_modules_new.return_union_binding_df()
    ...
    combined_df.to_csv('{}/union_binding.csv'.format(outdir),index=False)
    combined_df.iloc[:,:4].to_csv('{}/union_binding.bed'.format(outdir),index=False,sep='\t',header=None)
