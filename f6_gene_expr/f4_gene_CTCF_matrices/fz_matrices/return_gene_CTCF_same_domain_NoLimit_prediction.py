...
CTCF_domain_info_file = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/updated_201906/f6_gene_expr/f4_gene_CTCF_matrices/f2_gene_CTCF_domain/all_CTCF_domainInfo.csv'
CTCF_domain_df = pd.read_csv(CTCF_domain_info_file,index_col=2,sep='\t')
...
def same_domain_overlapped_gene_ids(ctcf_id):
    ...
    domain_left = CTCF_domain_df.loc[ctcf_id,'domain_left']
    domain_right = CTCF_domain_df.loc[ctcf_id,'domain_right']
...
def main():
    ...
    outdir = 'gene_CTCF_same_domain_NoLimit_prediction'
