...
#         chr='chr21'
    ...
    with open('CTCF_domain_GT100K_LT1M_allGene_hicorGene.json','w') as json_file:
        json.dump(ctcf_domain_gene_dic, json_file)
#     with open('CTCF_domain_GT100K_LT1M_allGene_hicorGene.json', 'r') as json_file:
#         ctcf_domain_gene_dic = json.load(json_file)        

#     with open('CTCF_domain_GT100K_LT1M_allGene_hicorGene.yml','w') as yaml_outf:
#         yaml.dump(ctcf_domain_gene_dic, yaml_outf)
#     with open('CTCF_domain_GT100K_LT1M_allGene_hicorGene.yml', 'r') as yaml_inf:
