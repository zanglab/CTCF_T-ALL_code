...
def intra_domain_diff_gene_plot_nobreak(cancertypes,pos_list,neg_list,figname,ylim1,ylim2,xticklabels=None,legend=None,ylabels=None,title=None,legend_loc=None):
    ...
    if legend_loc=="lower right":
        axes[1].legend([m[0],m[1],m[2],m[3]],legend,frameon=False,fontsize=13,loc="lower right",borderaxespad=-2,labelspacing=.2,handlelength=1) 
    else:
        axes[0].legend([m[0],m[1],m[2],m[3]],legend,frameon=False,fontsize=13,loc="upper right",borderaxespad=-2,labelspacing=.2,handlelength=1) 
