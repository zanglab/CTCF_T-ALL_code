...
def cancer_specific_binding(suf_name):
    ...
    outdir = 'f5_cancer_specific_binding_TALL_patinet_{}'.format(suf_name)
    ...
    for cancertype in cancertypes: 
        ...
        all_feature_file = par_dir+os.sep+'f4_combined_TALL_patients_{}/{}_binding_features.csv'.format(suf_name,cancertype)
