...
#     chroms=['chr21','chr22']
    ...
    info_df.to_csv(outdir+os.sep+'{}_domain_NoLimit_DEG_{}.csv'.format(dataType,flag))


def main():

    outdir = 'f2_ctcf_domain_NoLimit_DEG'
    ...
    for dataType in dataTypes:
        up_genes,dn_genes = CTCF_TALL_modules_new.return_cancertype_deg(dataType,fc_thre,padj_thre)
