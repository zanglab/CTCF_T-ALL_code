...
plt.legend(fontsize=14,borderaxespad=0.1,labelspacing=.1,handletextpad=0.2,loc="upper right",frameon=False)
plt.yscale('log')
# plt.xlabel('# Occupancy score\nin 771 datasets',fontsize=20)
plt.xlabel('Occupancy score',fontsize=16)
plt.ylabel('Number of CTCF sites',fontsize=16)
