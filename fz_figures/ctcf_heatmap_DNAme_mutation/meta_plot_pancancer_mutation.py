...
#     plt.axes().text(xleft,df.shape[0]*1.3,'-',ha='center',fontsize=20)
    ...
    ax.set_yticks([])
    ax.set_xticks([])
    ax.set_title('$\Delta$motif-score',va='baseline',fontsize=18,x=.65)
...
outdir = 'pancancer_fig_mutation'
os.makedirs(outdir,exist_ok=True)
os.makedirs(outdir+os.sep+'csv',exist_ok=True)

cancertypes = ["AML","T-ALL","CRC","BRCA","LUAD","PRAD_TissueAdded"]
...
#         cancer_file = "data/plot_data_CTCF_heatmap_rerank_by_methylation/{}_{}_cancer.csv".format(bindingtype,cancertype)
        normal_file = ctcf_binding_dir+os.sep+"{}_{}_normal.csv".format(bindingtype,cancertype)
        cancer_file = ctcf_binding_dir+os.sep+"{}_{}_cancer.csv".format(bindingtype,cancertype)
