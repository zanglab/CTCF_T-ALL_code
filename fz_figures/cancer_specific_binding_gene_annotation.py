...
def compr_plot_box(annotation,flag,outdir):
    ...
    plt.ylim([0,100])
    plt.xlim([0.3,6.7])
    plt.title('{}'.format(flag.capitalize()),fontsize=18)
    if flag=='gained':
        plt.legend([g3,g2,g1,g0],["Promoter","Exon","Intron","Intergenic"],loc=1,bbox_to_anchor=(1.9,1.03),fontsize=15,borderaxespad=0.,labelspacing=.2,handletextpad=0.2,handlelength=1,frameon=False)
