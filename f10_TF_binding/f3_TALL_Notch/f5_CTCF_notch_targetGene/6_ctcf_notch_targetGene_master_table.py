...
#             print(combined_df.columns);exit()
            for keep_annt in ['chr','start','end','motif_strand','if_intra_domain_dynamic_notch','all_patients_peaks']:
                master_df.loc[master_df_ii,keep_annt] = combined_df.loc[gained_id,keep_annt]
