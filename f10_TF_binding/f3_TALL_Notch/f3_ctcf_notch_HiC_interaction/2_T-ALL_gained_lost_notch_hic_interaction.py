    ...
    for id_index in df.index:
        ...
        if overlap_info==1:
            ...
            for pos2 in notch_poses:
                ...
                tmp_score = interactions_2m_list.loc[str(compr_list_pos)]
...
def main():
    ...
    outdir = 'f2_dynamic_CTCF_Notch1_hic_interaction'
    ...
    jurkat_raw_file = '/nv/vol190/zanglab/zw5j/work2017/T_ALL_CTCF/updated_201906/f4_HiC_TADs/f1_union_binding_processed/f2_union_binding_view2M_bothside_interaction//Jurkat_raw_res5000_union.csv'
    ...
    process_df_get_hic_interaction(df_tmp,jurkat_raw_file,outdir+os.sep+'{}_ctcf_notch_interaction_vs_bg_in_{}.csv'.format(basename,'jurkat_raw'))
