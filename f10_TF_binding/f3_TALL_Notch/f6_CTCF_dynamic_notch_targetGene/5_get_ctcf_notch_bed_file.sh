...
tail -n +2 f4_interaction_compr_zscores/raw_T-ALL_gained_zscore_delta_change_filtered.txt|awk '{OFS="\t";print$2,$3-10,$3+10,$1}'> f5_ctcf_notch_bed_file/gaiend_CTCF.bed
