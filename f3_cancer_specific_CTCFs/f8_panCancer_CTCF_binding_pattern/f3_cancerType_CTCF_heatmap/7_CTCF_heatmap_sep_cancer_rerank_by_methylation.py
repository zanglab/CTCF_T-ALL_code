...
#     plt.savefig(outdir+os.sep+'{}_CTCF_{}.pdf'.format(flag,cancertype),bbox_inches='tight',pad_inches=0.1,transparent=True,dpi=600)
    plt.savefig(outdir+os.sep+'{}_CTCF_{}.png'.format(flag,cancertype),bbox_inches='tight',pad_inches=0.1,transparent=True,dpi=600)
    plt.close();
...
def main():
    ...
    outdir = 'f7_CTCF_heatmap_sep_cancer_rerank_by_methylation'
