...
cancertype_prenema_title_list = \
    {'Jurkat':{'prenames':['T-ALL_normal','T-ALL_cancer_JURKAT'],'titles':['T cell','Jurkat']},\
     'CUTLL1':{'prenames':['T-ALL_normal','T-ALL_cancer_CUTLL1'],'titles':['T cell','CUTLL1']},\
...
def main():
    ...
    outdir = 'f6_CTCF_heatmap_TALL_patients_methylation_ranked'
    os.makedirs(outdir,exist_ok=True)

    cancertypes=['T-ALL_p1','T-ALL_p2','Jurkat','CUTLL1']
