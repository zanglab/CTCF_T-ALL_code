...
cancertype_prenema_title_list = \
    {'T-ALL':{'prenames':['T-ALL_normal','T-ALL_cancer_JURKAT','T-ALL_cancer_CUTLL1'],\
    'titles':['T cell','Jurkat','CUTLL1']}}    
...
#     if flag=='gained':
#         rank_index = gained_df.sort_values(by=['cancer_mean'],ascending=False).index
#     elif flag=='lost':
#         rank_index = lost_df.sort_values(by=['cancer_mean'],ascending=False).index   
...
def main():
    ...
    outdir = 'f5_CTCF_heatmap_TALL_vs_CD4'
